...
func TestSnapshotCrossValidation(t *testing.T) {
	cfg := validConfig("/tmp/u")
	site := SiteConfig{SchemaVersion: 2, ID: "example-com", Enabled: true, Domain: "example.com", ProjectPath: "/srv/p", DocumentRoot: "/srv/p/public", PHP: "8.3", Nginx: NginxConfig{Handler: HandlerConfig{Type: "generic"}}}
